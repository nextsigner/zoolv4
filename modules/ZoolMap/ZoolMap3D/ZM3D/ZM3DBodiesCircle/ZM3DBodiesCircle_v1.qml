...
Model {
    ...
    Component{
        ...
        Model {
            ...
            property bool selected: z3d.objZm.cbi===bi
            onSelectedChanged: {
                if(selected){
                    z3d.setRotCamSen(-90-z3d.objZm.currentSignRot-1+parseInt(xModel.gdec))
                }
            }
    ...
    Component{
        ...
        Node{
            ...
            //property bool selected: z3d.objZm.cbi===n.bi
            property int bi: -1
            ...
            onSelectedChanged: {
                //                if(selected){
                //                    n.position=Qt.vector3d(0-z3d.objZm.d+150+80, 0, -50)
                //                }else{
                //                    n.position=Qt.vector3d(0-z3d.objZm.d+150+drz, 0, n.alt)
                //                }
            }
            Model {
                source: "#Sphere"
            ...
            Model {
                ...
                onIsPickedChanged: {
                    ...
                    if(isPicked){
                        ...
                        let nz=z3d.objZm.getObjZGdec(n.rotation.z)
                        //log.lv('nz:'+nz)
                        ncg.gdec=nz
                        //z3d.setRotCamSen(-90-z3d.objZm.currentSignRot-1+parseInt(n.gdec))
                    }else{
                        z3d.objZm.chi=-1
                        z3d.objZm.cbi=-4
                        camera.visible=true
            ...
            SequentialAnimation on position{
                ...
                PropertyAnimation {
                    duration: 500
                    to: Qt.vector3d(0-z3d.objZm.d+150+drz, 0, n.alt)
                    from: Qt.vector3d(0-z3d.objZm.d+150-140, 0, n.altBase)
                }
            }
            SequentialAnimation on position{
                running: n.selected
                PropertyAnimation {
                    duration: 500
                    from: Qt.vector3d(0-z3d.objZm.d+150+drz, 0, n.alt)
                    to: Qt.vector3d(0-z3d.objZm.d+150-140, 0, n.altBase)
                }
            }
            Component.onCompleted:{
                let vh1=n.aIHs[n.bi]
                ...
                position=Qt.vector3d(0-z3d.objZm.d+150+drz, 0, n.alt)
            }
        }
    }
    Component{
        ...
        Node{
            id: n
            //position: Qt.vector3d(0-z3d.objZm.d+130+n.drz, 0, -100)
            //rotation: Qt.vector3d(0, 90, 0)
...
//                rotation: Qt.vector3d(0, 90, 0)
                ...
                SequentialAnimation on position{
                    ...
                    PropertyAnimation {
                        duration: 500
                        //to: Qt.vector3d(0-z3d.objZm.d+150+drz, 0, n.alt)
                        to: Qt.vector3d(0-z3d.objZm.d+130+n.drz, 0, -100)
                        from: Qt.vector3d(0-z3d.objZm.d+150-140, 0, n.altBase)
                    }
                }
                SequentialAnimation on position{
                    ...
                    PropertyAnimation {
                        duration: 500
                        //from: Qt.vector3d(0-z3d.objZm.d+150+drz, 0, n.alt)
                        from: Qt.vector3d(0-z3d.objZm.d+130+n.drz, 0, -100)
                        to: Qt.vector3d(0-z3d.objZm.d+150-140, 0, n.altBase)
                    }
                }
                Node{
    ...
    Component{
        ...
        Model {
            source: "#Cube"
            scale: Qt.vector3d(0.5, 0.5, 0.5)
            position: Qt.vector3d(0-z3d.objZm.d+150, 0, 0)
            rotation: Qt.vector3d(0, 90, 0)
            materials: [
                DefaultMaterial {
                    id: cubeMaterial
    ...
    Component{
        ...
        Model {
            ...
            source: "#Cone"
            scale: Qt.vector3d(1.0, 1.0, 1.0)
            position: Qt.vector3d(0-z3d.objZm.d+80, 0, -50)
