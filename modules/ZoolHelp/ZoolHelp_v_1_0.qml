...
Rectangle{
    ...
    property var aAsuntos: ['Inicio', 'Teclado', 'Mouse', 'Mapa Astrológico', 'Panel Cuerpos', 'Panel Secciones', 'Sabianos', 'Evolutiva', 'Editar Archivo', 'Advertencias', 'Agradecimientos', 'Sobre Qt']
