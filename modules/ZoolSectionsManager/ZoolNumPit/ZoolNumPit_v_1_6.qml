...
Rectangle {
    ...
    function getTodo(formula){
        ...
        if(num===13||num===14||num===16||num===19){
            num=r.currentNumNacimiento
            zpn.logTemp('d/m/a: '+d+'/'+m+'/'+a, 10000)
            zpn.logTemp('num: '+num, 10000)
        }
    ...
    function setPins(){
        ...
        let tPin=bigNumToPitNum(parseInt(mfecha[0]) + parseInt(mfecha[1]), false)
        if(tPin>9){
            m0=(''+tPin).split('')
        ...
        tPin=bigNumToPitNum(parseInt(mfecha[1])+parseInt(mfecha[2]), false)
        //zpn.log('°2 tPin: '+tPin)
        if(tPin>9){
            m0=(''+tPin).split('')
            tPin=parseInt(m0[0])+parseInt(m0[1])
        ...
        tPin=bigNumToPitNum(r.currentTipoPin1 + r.currentTipoPin2, false)
        if(tPin>9){
            m0=(''+tPin).split('')
            tPin=parseInt(m0[0])+parseInt(m0[1])
        }
        ...
        tPin=bigNumToPitNum(parseInt(mfecha[0]) + parseInt(mfecha[2]), false)
        //zpn.log('°4 tPin: '+tPin)
        if(tPin>9){
            m0=(''+tPin).split('')
            tPin=parseInt(m0[0])+parseInt(m0[1])
...
/*
Clave Para calcular los Pináculos
Primero necesitamos la reducción de fecha de nacimiento.
Por Ej. (20/6/1975):
SV (Sendero de Vida o Número de Destino): M+D+A=6+2+1975(22)=30=3

Primer Pináculo termina a la edad de = 36 - 3 (Número de Sendero de Vida)=33 años.

Pináculo Abarca la Edad DuraciónComentarios
1er Pináculo Desde el nacimiento hasta 33 años.
2do Pináculo Desde los 34 hasta los 42 años.
3er Pináculo Desde los 43 hasta los 51 años.
4to Pináculo Desde los 52 años en adelante.

Pináculo:1. Primer Pináculo (La Primera Cima)
Fórmula: D + M (Día reducido más Mes reducido)
Cálculo: 2 + 6 = 8
Resultado: 8.

Segundo Pináculo (La Segunda Cima)
Fórmula: M + A (Mes reducido más Año reducido)
Cálculo: 6 + 22 = 28 2 + 8 = 10 = 1 + 0 = 1
Resultado: 1.

Tercer Pináculo (La Tercera Cima)
Fórmula: pińaculo_1 + pinaculo_2 (Primer Pináculo más Segundo Pináculo)
Cálculo: 8 + 1 = 9
Resultado: 9.

4. Cuarto Pináculo (La Cima Final)
Fórmula: D + A (Día reducido más Año reducido)
Cálculo: 2 + 22 = 24 = 2 + 4 = 6
Resultado: 6
*/
