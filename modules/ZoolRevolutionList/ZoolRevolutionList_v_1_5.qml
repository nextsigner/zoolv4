...
//            }
    ...
    function setRsList(edad){
        ...
        if(!checkBoxRetSolar.checked){
            finalCmd+=''+app.pythonLocation+' "'+u.currentFolderPath()+'/py/astrologica_swe_search_revsol_time.py" '+cd3.getDate()+' '+parseInt(cd3.getMonth() +1)+' '+cd3.getFullYear()+' '+cd3.getHours()+' '+cd3.getMinutes()+' '+zm.currentGmt+' '+zm.currentLat+' '+zm.currentLon+' '+zm.currentGradoSolar+' '+zm.currentMinutoSolar+' '+zm.currentSegundoSolar+' '+edad+' "'+u.currentFolderPath()+'"'//+' '+hsys
        }else{
            finalCmd+=''+app.pythonLocation+' "'+u.currentFolderPath()+'/py/astrologica_swe_search_revsol_time.py" '+cd3.getDate()+' '+parseInt(cd3.getMonth() +1)+' '+cd3.getFullYear()+' '+cd3.getHours()+' '+cd3.getMinutes()+' '+0+' '+r.ulat+' '+r.ulon+' '+zm.currentGradoSolar+' '+zm.currentMinutoSolar+' '+zm.currentSegundoSolar+' '+edad+' "'+u.currentFolderPath()+'"'//+' '+hsys
        }
