...
Rectangle{
    id: r
    width: z3d.fs*20
    //height: xz3d.height-(xz3d.height-xBottomBar.y)-(xDataBar.state==='show'?xDataBar.height:0)
    height: z3d.height//-(z3d.height-xBottomBar.y)-(zoolDataView.state==='show'?zoolDataView.height:0)
    color: 'black'
    visible: false
    border.width: 2
    border.color: 'white'
    ...
    Flickable{
        ...
        Item{
            id: xTaLog
            width: r.width-z3d.fs
            height: taLog.contentHeight
            anchors.horizontalCenter: parent.horizontalCenter
            TextArea{
                id: taLog
                width: parent.width//-z3d.fs*2//*0.5
                //height: contentHeight
                wrapMode: r.ww?Text.WordWrap:Text.WrapAnywhere
                anchors.horizontalCenter: parent.horizontalCenter
                //anchors.top: parent.top
                //anchors.topMargin: z3d.fs*0.5
                font.pixelSize: z3d.fs*0.5
                color: 'white'
    ...
    Rectangle{
        ...
        anchors.rightMargin: z3d.fs*0.1
        anchors.top: parent.top
        anchors.topMargin: z3d.fs*0.1
