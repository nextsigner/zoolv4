...
//    //property color c: parent.colors[ci]
//    property var aSources: [u.currentFolderPath()+"/modules/ZM3D/ZM3DBodiesCircle/imgs/sol/basecolor2.jpg", u.currentFolderPath()+"/modules/ZM3D/ZM3DBodiesCircle/imgs/sol/metallic.jpg", u.currentFolderPath()+"/modules/ZM3D/ZM3DBodiesCircle/maps/metallic/roughness.jpg", u.currentFolderPath()+"/modules/ZM3D/ZM3DBodiesCircle/imgs/sol/basecolor1.jpg", u.currentFolderPath()+"/modules/ZM3D/ZM3DBodiesCircle/imgs/sol/metallic.jpg"]
...
//    //Materiales
//    // El Sol: Usamos emisión para el brillo propio
//        DefaultMaterial {
//            id: matSol
//            diffuseColor: "#ffcc00"
...
//        // Mercurio: Gris oscuro, sin brillo (mate)
//        DefaultMaterial {
//            id: matMercurio
//            diffuseColor: "#8c8c8c"
//            specularAmount: 0 // Sin reflejos
//        }

//        // Venus: Crema, brillo suave y difuso
//        DefaultMaterial {
//            id: matVenus
//            diffuseColor: "#e3bb76"
//            specularAmount: 0.2
...
//        // Júpiter: Café claro, poco brillo
//        DefaultMaterial {
//            id: matJupiter
//            diffuseColor: "#d39c7e"
//            specularAmount: 0.1
...
//        // Urano: Cian pálido, algo más de brillo plástico/gaseoso
//        DefaultMaterial {
//            id: matUrano
//            diffuseColor: "#b5e3e3"
//            specularAmount: 0.3
...
//        // Luna: Gris claro totalmente mate
//        DefaultMaterial {
//            id: matLuna
//            diffuseColor: "#d1d1d1"
//            specularAmount: 0
...
//                        objName='Sol'
//                        tipo='personal'
//                        aS=[u.currentFolderPath()+"/modules/ZM3D/ZM3DBodiesCircle/"+"imgs/sol/basecolor2.jpg", "imgs/sol/metallic.jpg", u.currentFolderPath()+"/modules/ZM3D/ZM3DBodiesCircle/"+"maps/metallic/roughness.jpg", "imgs/sol/metallic.jpg"]
//                    }else if(i===1){//Luna
//                        s=0.8
//                        altBase=0-(100*s*1.8)
//                        drz=r.aD[0]
//                        objName='Luna'
//                        tipo='personal'
//                        aS=[u.currentFolderPath()+"/modules/ZM3D/ZM3DBodiesCircle/"+"imgs/luna/basecolor2.jpg", "imgs/luna/metallic.jpg", u.currentFolderPath()+"/modules/ZM3D/ZM3DBodiesCircle/"+"maps/metallic/roughness.jpg", "imgs/luna/basecolor1.jpg", "imgs/luna/metallic.jpg"]
//                    }else if(i===2){//Mercurio
//                        s=0.6
//                        altBase=0-(100*s*2.5)
//                        drz=r.aD[0]+r.aD[1]
//                        objName='Mercurio'
//                        tipo='personal'
//                        aS=[u.currentFolderPath()+"/modules/ZM3D/ZM3DBodiesCircle/"+"imgs/mercurio/basecolor2.jpg", u.currentFolderPath()+"/modules/ZM3D/ZM3DBodiesCircle/"+"imgs/mercurio/metallic.jpg", u.currentFolderPath()+"/modules/ZM3D/ZM3DBodiesCircle/"+"maps/metallic/roughness.jpg", u.currentFolderPath()+"/modules/ZM3D/ZM3DBodiesCircle/"+"imgs/mercurio/basecolor2.jpg", u.currentFolderPath()+"/modules/ZM3D/ZM3DBodiesCircle/"+"imgs/mercurio/metallic.jpg"]
//                    }else if(i===3){//Venus
//                        s=1.0
//                        altBase=0-(100*s*1.5)
//                        drz=r.aD[0]+r.aD[1]+r.aD[2]
//                        objName='Venus'
//                        tipo='personal'
//                        aS=[u.currentFolderPath()+"/modules/ZM3D/ZM3DBodiesCircle/"+"imgs/venus/basecolor2.jpg", u.currentFolderPath()+"/modules/ZM3D/ZM3DBodiesCircle/"+"imgs/venus/metallic.jpg", u.currentFolderPath()+"/modules/ZM3D/ZM3DBodiesCircle/"+"maps/metallic/roughness.jpg", "imgs/venus/basecolor1.jpg", "imgs/venus/basecolor2.jpg"]
//                    }else if(i===4){//Marte
//                        s=0.75
//                        altBase=0-(100*s*2.0)
//                        drz=r.aD[0]+r.aD[1]+r.aD[2]+r.aD[3]
//                        objName='Marte'
//                        tipo='personal'
//                        aS=[u.currentFolderPath()+"/modules/ZM3D/ZM3DBodiesCircle/"+"imgs/marte/basecolor2.jpg", u.currentFolderPath()+"/modules/ZM3D/ZM3DBodiesCircle/"+"imgs/marte/metallic.jpg", u.currentFolderPath()+"/modules/ZM3D/ZM3DBodiesCircle/"+"maps/metallic/roughness.jpg", "imgs/marte/basecolor2.jpg", u.currentFolderPath()+"/modules/ZM3D/ZM3DBodiesCircle/"+"imgs/marte/metallic.jpg"]
//                    }else if(i===5){//Jupiter
//                        s=1.0
//                        altBase=0-(100*s*1.5)
//                        drz=r.aD[4]
//                        objName='Jupiter'
//                        tipo='social'
//                        aS=[u.currentFolderPath()+"/modules/ZM3D/ZM3DBodiesCircle/"+"imgs/jupiter/basecolor2.jpg", u.currentFolderPath()+"/modules/ZM3D/ZM3DBodiesCircle/"+"imgs/jupiter/metallic.jpg", u.currentFolderPath()+"/modules/ZM3D/ZM3DBodiesCircle/"+"maps/metallic/roughness.jpg", "imgs/jupiter/basecolor2.jpg", u.currentFolderPath()+"/modules/ZM3D/ZM3DBodiesCircle/"+"imgs/jupiter/metallic.jpg"]
//                    }else if(i===6){//Saturno
//                        s=0.8
//                        altBase=0-(100*s*2.0)
//                        drz=r.aD[4]+r.aD[5]
...
//                        indexOfRefraction: 0.0//De 1.0 3.0
//                        opacity: 0.5
//                        baseColorMap: Texture {source: r.aSources[3]}
//                        //baseColorMap: Texture {source: r.aSources[bi]}
//                        //baseColorMap: Texture {source: '/home/ns/nsp/zoolv4/modules/ZM3D/ZM3DBodiesCircle/imgs/marte/basecolor.jpg'}
//                        //Metalizar
//                        metalness: 0.1 //De 0.0 a 1.0
//                        metalnessMap: Texture { source: r.aSources[3]}//Metalicidad
//                        //Arrugar
//                        roughnessMap: Texture { source: u.currentFolderPath()+"/modules/ZM3D/ZM3DBodiesCircle/"+"maps/metallic/roughness.jpg" }//Rugosidad
//                        roughness: 0.0 //De 0.0 a 1.0
...
//            //Atril donde se posa el cuerpo al mostrarse
//            Node{
//                id: rootNodeBase
//                scale: Qt.vector3d(0.2, n.s, 0.2)
//                rotation: Qt.vector3d(0, 90, 90)
...
//            //Solido de Esfera semitransparent
//            Model {
//                id: esferaPrincipal
//                //visible: false
//                source: "#Sphere"
...
//                        indexOfRefraction: 0.0//De 1.0 3.0
//                        opacity: 0.5
//                        baseColorMap: Texture {id: s1matc1; source: r.aSources[0]}
//                        //Metalizar
//                        metalness: 0.1 //De 0.0 a 1.0
//                        metalnessMap: Texture {id: s2matc1;  source: r.aSources[1] }//Metalicidad
//                        //Arrugar
//                        roughnessMap: Texture {id: s3matc1;  source: r.aSources[2] }//Rugosidad
//                        roughness: 0.0 //De 0.0 a 1.0
...
//                Component.onCompleted: {
//                    if(bi===0){
//                        esferaPrincipal.materials=[matSol]
//                    }else if(bi===1){
//                        esferaPrincipal.materials=[matLuna]
//                    }else if(bi===2){
//                        esferaPrincipal.materials=[matMercurio]
//                    }else if(bi===3){
//                        esferaPrincipal.materials=[matVenus]
//                    }else if(bi===4){
//                        esferaPrincipal.materials=[matMarte]
//                    }else if(bi===5){
//                        esferaPrincipal.materials=[matJupiter]
//                    }else if(bi===6){
//                        esferaPrincipal.materials=[matSaturno]
//                    }else if(bi===7){
//                        esferaPrincipal.materials=[matUrano]
//                    }else if(bi===8){
//                        esferaPrincipal.materials=[matNeptuno]
//                    }else if(bi===9){
//                        esferaPrincipal.materials=[matPluton]
//                    }else{
//                        esferaPrincipal.materials=[matDefault]
//                    }
//                }
//            }
//            Node{
...
//                        id: ejeVertical
//                        source: "#Cylinder"
//                        materials: [mat1]//baseEjeVertical.materials
//                        SequentialAnimation on position {
//                            loops: Animation.Infinite
//                            running: false//true
//                            PropertyAnimation {
