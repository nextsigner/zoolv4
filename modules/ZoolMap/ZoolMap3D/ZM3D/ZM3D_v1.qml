...
import ZoolMap.ZoolMap3D.ZM3D.ZM3DSignCircle 1.0
import ZoolMap.ZoolMap3D.ZM3D.ZM3DHousesCircle 1.0
import ZoolMap.ZoolMap3D.ZM3D.ZM3DBodiesCircle 1.0
...
Node{
    ...
    onCbiChanged: {
        if(r.cbi>=0){
            ...
            z3d.setRotCamSen(-90-z3d.objZm.currentSignRot-1+parseInt(z3d.objZm.cAscDeg))
        }
    }
    onChiChanged: {
        //log.lv('z3d.objZm.chi: '+chi)
    }
    ...
    function getObjZGdec(gdec){
        let nz=-90-z3d.objZm.currentSignRot-gdec+90
