...
import ZoolMap.ZoolMap3D.ZM3D 1.0
import ZoolMap.ZoolMap3D.Luces 1.0
import ZoolMap.ZoolMap3D.Sen 1.0
...
Rectangle{
    ...
    MouseArea {
        ...
        onWheel: {
            ...
            if (wheel.modifiers & Qt.ControlModifier) {
                ...
                if(wheel.angleDelta.y>=0){
                    //                    if(reSizeAppsFs.fs<r.fs*2){
                    //                        reSizeAppsFs.fs+=reSizeAppsFs.fs*0.1
                    //                    }else{
                    //                        reSizeAppsFs.fs=r.fs
                    //                    }
                    pointerPlanet.pointerRot+=45
                }else{
                    //                    if(reSizeAppsFs.fs>r.fs){
                    //                        reSizeAppsFs.fs-=reSizeAppsFs.fs*0.1
                    //                    }else{
                    //                        reSizeAppsFs.fs=r.fs*2
                    //                    }
                    //pointerPlanet.pointerRot-=45
                }
            }
    ...
    Shortcut{
        ...
        onActivated: {
            z3d.objZm.cbi=-1
            //r.setRotCamSen(-90-z3d.objZm.currentSignRot-1+parseInt(z3d.objZm.cAscDeg))
        }
    }
    Shortcut{
        sequence: '0'
