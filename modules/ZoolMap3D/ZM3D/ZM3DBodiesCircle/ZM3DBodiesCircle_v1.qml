    ...
    Component{
        ...
        Model {
            ...
            PointLight {
                ...
                // 1. Posición: La elevamos 200 unidades sobre el Sol en el eje Z
                // para que "bañe" la escena desde arriba/afuera.
                position: Qt.vector3d(-500, -500, -2000)

                // 2. Brillo: Subimos a 1000 o más.
                // En algunas versiones de 5.14, si la escala es grande, se requieren valores altos.
                //brightness: 1000.0
                brightness: 50

                // 3. Atenuación Cero: Esto es vital.
                // Al poner estos en 0, la luz no pierde fuerza con la distancia.
                //constantFade: 1.0
                //linearFade: 0.0
                //quadraticFade: 0.0
        ...
        Node{
            ...
            Node{
                ...
                PointLight {
                    position.x: -250
                    position.y: 150
                    brightness: cfg.intensidadBrilloSolar*0.25
                    color: n.colorLuzSolar
                    Model {
                        visible: n.showBoxPos; source: "#Cube"; scale: Qt.vector3d(n.s, n.s, n.s); materials: [DefaultMaterial{diffuseColor: n.colorLuzSolar}]
                    }
                }
                PointLight {
                    position.x: -250
