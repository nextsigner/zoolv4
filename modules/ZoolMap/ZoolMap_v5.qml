...
Rectangle{
    ...
    function load(j){
        ...
        c+='    let cmd=\''+app.pythonLocation+' "'+unik.currentFolderPath()+'/py/'+app.sweBodiesPythonFile+'" '+vd+' '+vm+' '+va+' '+vh+' '+vmin+' '+vgmt+' '+vlat+' '+vlon+' '+hsys+' "'+app.sweFolder+'" '+valt+'\'\n'
    ...
    function loadBack(j){
        ...
        c+='    }\n'
        c+='    Component.onCompleted:{\n'
        c+='        let cmd=\'zm.loadBack() '+app.pythonLocation+' "'+unik.currentFolderPath()+'/py/'+app.sweBodiesPythonFile+'" '+vd+' '+vm+' '+va+' '+vh+' '+vmin+' '+vgmt+' '+vlat+' '+vlon+' '+hsys+' "'+app.sweFolder+'" '+valt+'\'\n'
        c+='    if(apps.showLog){\n'
